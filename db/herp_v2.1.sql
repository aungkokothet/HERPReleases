...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 22, 2020 at 03:54 PM
...
CREATE TABLE `outpatient_care` (
  ...
  `patient_id` bigint(20) NOT NULL,
  `doctor_id` bigint(20) NOT NULL,
  `opd_room_id` bigint(20) DEFAULT NULL,
  `status` int(1) NOT NULL,
  `created_user_id` bigint(20) NOT NULL,
  `created_time` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_user_id` bigint(20) NOT NULL,
...
ALTER TABLE `diagnosis`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_diagnosis_diagnosis_type` (`diagnosis_type_id`);
...
ALTER TABLE `emergency_care`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_emergency_care_patient` (`patient_id`),
  ADD KEY `fk_emergency_care_doctor` (`doctor_id`);
...
ALTER TABLE `inpatient_care`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_inpatient_care_patient` (`patient_id`),
  ADD KEY `fk_inpatient_care_doctor` (`doctor_id`),
  ADD KEY `fk_inpatient_care_ipd_bed` (`ipd_bed_id`);
...
ALTER TABLE `medical_record`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_medical_record_emergency_care` (`care_id`);
...
ALTER TABLE `medical_record_diagnosis`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_medical_record_diagnosis_medical_record` (`medical_record_id`),
  ADD KEY `fk_medical_record_diagnosis_diagnosis` (`diagnosis_id`);
...
ALTER TABLE `medical_record_prescription`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_medical_record_prescription_medical_record` (`medical_record_id`);
...
ALTER TABLE `outpatient_care`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_outpatient_care_appointment` (`appointment_id`),
  ADD KEY `fk_outpatient_care_patient` (`patient_id`),
  ADD KEY `fk_outpatient_care_doctor` (`doctor_id`),
  ADD KEY `fk_outpatient_care_opd_room` (`opd_room_id`);
...
--
-- AUTO_INCREMENT for table `diagnosis_type`
--
ALTER TABLE `diagnosis_type`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `diagnosis`
  ADD CONSTRAINT `fk_diagnosis_diagnosis_type` FOREIGN KEY (`diagnosis_type_id`) REFERENCES `diagnosis_type` (`id`);

--
-- Constraints for table `emergency_care`
--
ALTER TABLE `emergency_care`
  ADD CONSTRAINT `fk_emergency_care_doctor` FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`id`),
  ADD CONSTRAINT `fk_emergency_care_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`);

--
-- Constraints for table `inpatient_care`
--
ALTER TABLE `inpatient_care`
  ADD CONSTRAINT `fk_inpatient_care_doctor` FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`id`),
  ADD CONSTRAINT `fk_inpatient_care_ipd_bed` FOREIGN KEY (`ipd_bed_id`) REFERENCES `ipd_bed` (`id`),
  ADD CONSTRAINT `fk_inpatient_care_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`);

--
-- Constraints for table `medical_record`
--
ALTER TABLE `medical_record`
  ADD CONSTRAINT `fk_medical_record_emergency_care` FOREIGN KEY (`care_id`) REFERENCES `emergency_care` (`id`),
  ADD CONSTRAINT `fk_medical_record_inpatient_care` FOREIGN KEY (`care_id`) REFERENCES `inpatient_care` (`id`),
  ADD CONSTRAINT `fk_medical_record_outpatient_care` FOREIGN KEY (`care_id`) REFERENCES `outpatient_care` (`id`);

--
-- Constraints for table `medical_record_diagnosis`
--
ALTER TABLE `medical_record_diagnosis`
  ADD CONSTRAINT `fk_medical_record_diagnosis_diagnosis` FOREIGN KEY (`diagnosis_id`) REFERENCES `diagnosis` (`id`),
  ADD CONSTRAINT `fk_medical_record_diagnosis_medical_record` FOREIGN KEY (`medical_record_id`) REFERENCES `medical_record` (`id`);

--
-- Constraints for table `medical_record_prescription`
--
ALTER TABLE `medical_record_prescription`
  ADD CONSTRAINT `fk_medical_record_prescription_medical_record` FOREIGN KEY (`medical_record_id`) REFERENCES `medical_record` (`id`);

--
-- Constraints for table `outpatient_care`
--
ALTER TABLE `outpatient_care`
  ADD CONSTRAINT `fk_outpatient_care_appointment` FOREIGN KEY (`appointment_id`) REFERENCES `appointment` (`id`),
  ADD CONSTRAINT `fk_outpatient_care_doctor` FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`id`),
  ADD CONSTRAINT `fk_outpatient_care_opd_room` FOREIGN KEY (`opd_room_id`) REFERENCES `opd_room` (`id`),
  ADD CONSTRAINT `fk_outpatient_care_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`);

--
-- Constraints for table `session`
--
ALTER TABLE `session`
  ADD CONSTRAINT `session_user_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
COMMIT;
